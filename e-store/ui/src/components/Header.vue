              ...
              <ul class="nav justify-content-end">
                <li class="nav-item">
                  <a class="nav-link" href="#">
                    <router-link to="/CheckOut" style="color: white; text-decoration: none">
                      <i class="fa fa-shopping-cart"></i>
                      Cart ({{ Object.keys($store.state.Order).length }})
                    </router-link>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link">
                    <router-link to="/SignUp" style="
                        color: #fff;
                        font-size: 16px;
                        font-weight: 500;
                        text-decoration: none;
                      "><i class="fa fa-user"> </i> SignUp</router-link>
                  </a>
                </li>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link" href="#"><router-link to="/">Home</router-link>
                </a>
              </li>
              <li class="nav-item">
                <nav>
                  <div class="wrapper">
                    <ul class="nav-links">
                      <li class="position-static menu-item-has-children">
                        <a class="nav-link" href="#"><router-link to="/AllCategories">All Company
                          </router-link>
                        </a>
                        <div class="mega-box">
                          <div class="content">
                            <div class="row">
                              ...
                              <ul class="mega-links">
                                <li>
                                  <a href="#"><router-link to="Samsung">SAMSUNG</router-link>
                                  </a>
                                </li>
                                <li>
                                  <a href="#"><router-link to="Apple">APPLE</router-link></a>
                                </li>
                                <li>
                                  <a href="#"><router-link to="Xiaomi">XIAOMI</router-link></a>
                                </li>
                                <li>
                                  <a href="#"><router-link to="HuaWei">HUAWEI</router-link></a>
                                </li>
                                <li>
                                  <a href="#"><router-link to="Nokia">NOKIA</router-link></a>
                                </li>
                                <li>
                                  <a href="#"><router-link to="Htc">HTC</router-link></a>
                                </li>
                                <li>
                                  <a href="#"><router-link to="Tecno">TECNO</router-link></a>
                                </li>
                                <li>
                                  <a href="#">NOTHING</a>
                                </li>
                            ...
                            <div class="row">
                              <ul class="mega-links">
                                <li>
                                  <a href="#"><router-link to="Lg">LG</router-link></a>
                                </li>
                                <li>
                                  <a href="#"><router-link to="Honor">HONOR</router-link></a>
                                </li>
                                <li>
                                  <a href="#"><router-link to="Google">GOOGLE</router-link></a>
                                </li>
                                <li>
                                  <a href="#"><router-link to="Lenovo">LENOVO</router-link></a>
                                </li>
                                <li>
                                  <a href="#"><router-link to="Oneplus">ONEPLUS</router-link></a>
                                </li>
                                <li>
                                  <a href="#"><router-link to="Oppo">OPPO</router-link></a>
                                </li>
                                <li>
                                  <a href="#"><router-link to="Infinix">INFINIX</router-link></a>
                                </li>
                              </ul>
                            </div>
                            <div class="row">
                              <ul class="mega-links">
                                <li>
                                  <a href="#"><router-link to="Sony">SONY</router-link></a>
                                </li>
                                <li>
                                  <a href="#"><router-link to="Realme">REALME</router-link></a>
                                </li>
                                <li>
                                  <a href="#"><router-link to="Vivo">VIVO</router-link></a>
                                </li>
                                <li>
                                  <a href="#"><router-link to="Zte">ZTE</router-link></a>
                                </li>
                                <li>
                                  <a href="#"><router-link to="Meizu">MEIZU</router-link></a>
                                </li>
                                <li>
                                  <a href="#"><router-link to="Motorola">MOTOROLA</router-link></a>
                                </li>
                                <li>
                                  <a href="#"><router-link to="Asus">ASUS</router-link></a>
                                </li>
                              </ul>
                            </div>
                          </div>
              ...
              <li class="nav-item">
                <a class="nav-link" href="#"><router-link to="Compare">Compare</router-link>
                </a>
              </li>
            </ul>
          </div>
