  ...
  <div class="aaa">
    <section class="wwrapper">
      ...
      <div class="form login">
        <header>Login</header>
        <form action="#">
          <input class="bbb" type="text" placeholder="Email address" required />
          <input class="bbb" type="password" placeholder="Password" required />
          <a href="#"><router-link to="/ForgotPassword"> Forgot password?</router-link>
          </a>
          <router-link to="/UserAccount" class="qwq"><input type="submit" class="bbb" value="Login" /></router-link>
        </form>
      </div>
    </section>
  </div>
