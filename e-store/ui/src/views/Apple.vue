          ...
          <div id="product-1" class="single-product">
            <div class="part-1">
              <ul>
                ...
                <li>
                  <a href="#"><router-link to="/DetailsProduct"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                        height="16" fill="currentColor" class="bi bi-arrows-angle-expand" viewBox="0 0 16 16">
                        <path fill-rule="evenodd"
