  ...
  <body>
    <div class="container-fluid light-style container-p-y bg-dark">
            ...
            <div class="tab-content">
              <div class="tab-pane fade active show" id="account-general">
                <div class="card-body media align-items-center">
                  ...
                  <div class="media-body ml-6">
                    ...
                    &nbsp;
                    <button type="button" class="btn btn-dark md-btn-flat">
                      Reset
                    </button>
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control mb-1" value="" placeholder="nmaxwell" />
                  </div>
                  <div class="form-group">
                    <label class="form-label text-white">Name</label>
                    <input type="text" class="form-control" value="" placeholder="Nelle Maxwell" />
                  </div>
                  <div class="form-group">
                    <label class="form-label text-white">E-mail</label>
                    <input type="text" class="form-control mb-1" value="" placeholder="nmaxwell@mail.com" />
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio1"
                        value="option1 " style="padding-left: 15px" />
                      <label class="form-check-label text-white" for="inlineRadio1" style="padding-left: 15px">
                        female</label>
                    </div>
                    <div class="form-check form-check-inline">
                      <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio2"
                        value="option2" style="padding-left: 15px" />
                      <label class="form-check-label text-white" for="inlineRadio2"
                        style="padding-left: 15px">Male</label>
                    </div>
                  </div>
                </div>
              </div>
              <div class="tab-pane fade" id="account-change-password">
                <div class="card-body pb-2">
                  ...
                  <div class="form-group">
                    <label class="form-label text-white">Repeat new password</label>
                    <input type="password" class="form-control" />
                  </div>
                </div>
              </div>
              <div class="tab-pane fade" id="account-info">
                <div class="card-body pb-2">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="" placeholder="May 3, 1995" />
                  </div>
                  <div class="form-group">
                ...
                <div class="card-body pb-2">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" value="" placeholder="+0 (963) 956 7891" />
                  </div>
                  <div class="form-group">
                    <label class="form-label text-white">Address</label>
                    <input type="text" class="form-control" value="" placeholder="Syria/Damascus/Masakn Barzeh" />
                  </div>
                </div>
              </div>
              ...
              <div class="tab-pane fade" id="account-connections">
                <div class="card-body">
                  <button type="button" class="btn btn-twitter text-white btn-dark">
                ...
                <hr class="border-light m-0" />
                <div class="card-body">
                  <button type="button" class="btn btn-facebook text-white btn-dark">
                    Connect to <strong>Phone Number</strong>
                  </button>
                </div>
                <hr class="border-light m-0" />
                <div class="card-body">
                  <button type="button" class="btn btn-instagram text-white btn-dark">
      ...
      <div class="text-center">
        <button type="button" class="btn btn-primary btn-dark" style="padding: 15px">
          Save changes</button>&nbsp;
